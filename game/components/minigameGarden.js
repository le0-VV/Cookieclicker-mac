		...
		*/
		...
		M.tools={
			...
			'harvestAll':{
				...
				func:function(){
					PlaySound('assets/sounds/toneTick.mp3');
			...
			'freeze':{
				...
				func:function(){
					...
					{
						M.computeEffs();
						PlaySound('assets/sounds/freezeGarden.mp3');
			...
			'convert':{
				...
				func:function(){PlaySound('assets/sounds/toneTick.mp3');M.askConvert();},
			...
			if (me.children.length>0)
			{
				...
				for (var i in me.children)
				{
					...
					else
					{
						...
						else children+='<div class="gardenSeedTiny" style="background-image:url('+Game.resPath+'assets/images/icons.png?v='+Game.version+');background-position:'+(-0*48)+'px '+(-7*48)+'px;opacity:0.35;"></div>';
					}
				}
				children+='</div>';
			}
		...
		M.soilTooltip=function(id)
		{
			return function(){
				...
				var str='<div style="padding:8px 4px;min-width:350px;" id="tooltipGardenSoil">'+
					...
					):('<div class="icon" style="background:url('+Game.resPath+'assets/images/gardenPlants.png?v='+Game.version+');float:left;margin-left:-8px;margin-top:-8px;background-position:'+(-me.icon*48)+'px '+(-34*48)+'px;"></div>'+
		...
		M.seedTooltip=function(id)
		{
			return function(){
				...
				var str='<div style="padding:8px 4px;min-width:400px;" id="tooltipGardenSeed">'+
					'<div class="icon" style="background:url('+Game.resPath+'assets/images/gardenPlants.png?v='+Game.version+');float:left;margin-left:-24px;margin-top:-4px;background-position:'+(-0*48)+'px '+(-me.icon*48)+'px;"></div>'+
					'<div class="icon" style="background:url('+Game.resPath+'assets/images/gardenPlants.png?v='+Game.version+');float:left;margin-left:-24px;margin-top:-28px;background-position:'+(-4*48)+'px '+(-me.icon*48)+'px;"></div>'+
					'<div style="background:url('+Game.resPath+'assets/images/turnInto.png);width:20px;height:22px;position:absolute;left:28px;top:24px;z-index:1000;"></div>'+
		...
		M.toolTooltip=function(id)
		{
			return function(){
				...
				var str='<div style="padding:8px 4px;min-width:350px;" id="tooltipGardenTool">'+
					'<div class="icon" style="background:url('+Game.resPath+'assets/images/gardenPlants.png?v='+Game.version+');float:left;margin-left:-8px;margin-top:-8px;background-position:'+(-icon[0]*48)+'px '+(-icon[1]*48)+'px;"></div>'+
					...
					var str='<div style="padding:8px 4px;min-width:350px;">'+
						...
						'<div style="text-align:center;">'+
							'<div style="display:inline-block;position:relative;box-shadow:0px 0px 0px 1px #000,0px 0px 0px 1px rgba(255,255,255,0.5) inset,0px -2px 2px 0px rgba(255,255,255,0.5) inset;width:256px;height:6px;background:linear-gradient(to right,#fff 0%,#0f9 '+me.mature+'%,#3c0 '+(me.mature+0.1)+'%,#960 100%)">'+
								...
								'<div style="background:url('+Game.resPath+'assets/images/gardenPlants.png?v='+Game.version+');background-position:'+(-1*48)+'px '+(-icon[1]*48)+'px;position:absolute;left:'+(0-24)+'px;top:-32px;transform:scale(0.5,0.5);width:48px;height:48px;"></div>'+
								'<div style="background:url('+Game.resPath+'assets/images/gardenPlants.png?v='+Game.version+');background-position:'+(-2*48)+'px '+(-icon[1]*48)+'px;position:absolute;left:'+((((me.mature*0.333)/100)*256)-24)+'px;top:-32px;transform:scale(0.5,0.5);width:48px;height:48px;"></div>'+
								'<div style="background:url('+Game.resPath+'assets/images/gardenPlants.png?v='+Game.version+');background-position:'+(-3*48)+'px '+(-icon[1]*48)+'px;position:absolute;left:'+((((me.mature*0.666)/100)*256)-24)+'px;top:-32px;transform:scale(0.5,0.5);width:48px;height:48px;"></div>'+
								'<div style="background:url('+Game.resPath+'assets/images/gardenPlants.png?v='+Game.version+');background-position:'+(-4*48)+'px '+(-icon[1]*48)+'px;position:absolute;left:'+((((me.mature)/100)*256)-24)+'px;top:-32px;transform:scale(0.5,0.5);width:48px;height:48px;"></div>'+
							'</div><br>'+
		...
		M.buildPanel=function()
		{
			...
			for (var i in M.plants)
			{
				...
				AddEvent(me.l,'click',function(me){return function()
				{
					...
					else {M.seedSelected=me.id;PlaySound('assets/sounds/toneTick.mp3');}
					for (var i in M.plants)
					{
						var it=M.plants[i];
		...
		M.useTool=function(what,x,y)
		{
			...
			if (harvested)
			{
				...
				PlaySound('assets/sounds/harvest'+choose(['1','2','3'])+'.mp3',1,0.2);
			}
			else
			{
				if (what>=0 && M.canPlant(M.plantsById[what]))
				{
					...
					Game.SparkleAt(Game.mouseX,Game.mouseY);
					PlaySound('assets/sounds/tillb'+choose(['1','2','3'])+'.mp3',1,0.2);
					return true;
				}
			}
			return false;
		...
		M.harvestAll=function(type,mature,mortal)
		{
			...
			if (harvested>0) setTimeout(function(){PlaySound('assets/sounds/harvest1.mp3',1,0.2);},50);
			if (harvested>2) setTimeout(function(){PlaySound('assets/sounds/harvest2.mp3',1,0.2);},150);
			if (harvested>6) setTimeout(function(){PlaySound('assets/sounds/harvest3.mp3',1,0.2);},250);
		}
		...
		var str='';
		str+='<style>'+
		'#gardenBG{background:url('+Game.resPath+'assets/images/shadedBorders.png),url('+Game.resPath+'assets/images/BGgarden.jpg);background-size:100% 100%,auto;position:absolute;left:0px;right:0px;top:0px;bottom:16px;}'+
		...
		'.gardenTile:before{transform:translate(0,0);opacity:0.65;transition:opacity 0.2s;pointer-events:none;content:\'\';display:block;position:absolute;left:0px;top:0px;right:0px;bottom:0px;margin:0px;background:url('+Game.resPath+'assets/images/gardenPlots.png);}'+
		...
		'.gardenTileIcon{transform:translate(0,0);pointer-events:none;transform-origin:50% 40px;width:48px;height:48px;position:absolute;left:-'+((48-M.tileSize)/2)+'px;top:-'+((48-M.tileSize)/2+8)+'px;background:url('+Game.resPath+'assets/images/gardenPlants.png?v='+Game.version+');}'+
		...
		'#gardenCursor{transition:transform 0.1s;display:none;pointer-events:none;width:48px;height:48px;position:absolute;background:url('+Game.resPath+'assets/images/gardenPlants.png?v='+Game.version+');}'+
		'.gardenSeed{cursor:pointer;display:inline-block;width:40px;height:40px;position:relative;}'+
		'.gardenSeed.locked{display:none;}'+
		'.gardenSeedIcon{pointer-events:none;transform:translate(0,0);display:inline-block;position:absolute;left:-4px;top:-4px;width:48px;height:48px;background:url('+Game.resPath+'assets/images/gardenPlants.png?v='+Game.version+');}'+
		...
		'.gardenPanelLabel{font-size:12px;width:100%;padding:2px;margin-top:4px;margin-bottom:-4px;}'+'.gardenSeedTiny{transform:scale(0.5,0.5);margin:-20px -16px;display:inline-block;width:48px;height:48px;background:url('+Game.resPath+'assets/images/gardenPlants.png?v='+Game.version+');}'+
		'.gardenSeed.on:before{pointer-events:none;content:\'\';display:block;position:absolute;left:-10px;top:-10px;width:60px;height:60px;background:url('+Game.resPath+'assets/images/selectTarget.png);animation:wobble 0.2s ease-out;z-index:10;}'+
