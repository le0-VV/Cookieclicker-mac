	...
	*/
	...
	Game.Dungeon=function(type,id)
	{
		...
		this.Draw=function()
		{
			...
			l('picHero'+this.id).style.backgroundImage='url(assets/images/'+this.hero.portrait+'.png)';
		...
		this.Turn=function()
		{
			...
			if (this.currentOpponent)
			{
				...
				l('picMonster'+this.id).style.backgroundImage='url(assets/images/'+Game.Monsters[this.currentOpponent.subtype].pic+'.png)';
				l('nameMonster'+this.id).innerHTML=Game.Monsters[this.currentOpponent.subtype].name;
				l('picHero'+this.id).style.backgroundImage='url(assets/images/'+this.hero.pic+'.png)';
			}
			else
			{
		...
		this.DrawButton=function()
		{
			...
			str+='<div style="width:144px;height:144px;position:absolute;left:0px;bottom:0px;"><a class="specialButtonPic" style="background-image:url(assets/images/'+this.portalPic+'.png);" onclick="Game.ObjectsById['+this.id+'].setSpecial(1);"><div class="specialButtonText">Enter dungeons</div></a></div>';
			return str;
		}
