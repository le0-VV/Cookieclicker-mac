AddLanguage('PT-BR','portuguese',{
	...
	"[Achievement name 230]Brought to you by the letter <div style=\"display:inline-block;background:url(assets/images/money.png);width:16px;height:16px;\"></div>": "Trazido ao pé da letra <div style=\"display:inline-block;background:url(assets/images/money.png);width:16px;height:16px;\"></div>",
