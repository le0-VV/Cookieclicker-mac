AddLanguage('IT','italian',{
	...
	"[Achievement name 230]Brought to you by the letter <div style=\"display:inline-block;background:url(assets/images/money.png);width:16px;height:16px;\"></div>": "Comincia con la lettera <div style=\"display:inline-block;background:url(assets/images/money.png);width:16px;height:16px;\"></div>",
