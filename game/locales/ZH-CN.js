AddLanguage('ZH-CN','chinese',{
	...
	"[Achievement name 230]Brought to you by the letter <div style=\"display:inline-block;background:url(assets/images/money.png);width:16px;height:16px;\"></div>": "由字母呈现 <div style=\"display:inline-block;background:url(assets/images/money.png);width:16px;height:16px;\"></div>",
