AddLanguage('KO','korean',{
	...
	"[Achievement name 230]Brought to you by the letter <div style=\"display:inline-block;background:url(assets/images/money.png);width:16px;height:16px;\"></div>": "글자가 보냅니다 <div style=\"display:inline-block;background:url(assets/images/money.png);width:16px;height:16px;\"></div>",
